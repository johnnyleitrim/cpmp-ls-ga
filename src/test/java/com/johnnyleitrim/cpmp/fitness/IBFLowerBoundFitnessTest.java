...
public class IBFLowerBoundFitnessTest {

  private final FitnessAlgorithm fitnessAlgorithm = new IBFLowerBoundFitness();
  ...
  public void test2() {
    ...
    State state = new State(internalState, nStacks, nTiers);
    int actualFitness = fitnessAlgorithm.calculateFitness(state);
    assertThat(actualFitness).isEqualTo(9);
  }
  ...
  public void test3() {
    ...
    State state = new State(internalState, nStacks, nTiers);
    int actualFitness = fitnessAlgorithm.calculateFitness(state);
    assertThat(actualFitness).isEqualTo(17);
  }
  ...
  public void test4() {
    ...
    internalState[5] = new int[]{0, 0, 0, 0};
    internalState[4] = new int[]{0, 0, 0, 0};
    internalState[3] = new int[]{7, 1, 2, 12};
    internalState[2] = new int[]{6, 11, 16, 15};
    internalState[1] = new int[]{5, 14, 8, 10};
    internalState[0] = new int[]{3, 13, 9, 4};
    State state = new State(internalState, nStacks, nTiers);
    int actualFitness = fitnessAlgorithm.calculateFitness(state);
    assertThat(actualFitness).isEqualTo(16);
  }
}
