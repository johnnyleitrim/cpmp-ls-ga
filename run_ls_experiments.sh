...
CMD="java -cp target/classes/ com.johnnyleitrim.cpmp.ls.Main -runs 10 -maxSearchDuration 1 -returnFirstSolution true -perturbation LOWEST_MISOVERLAID_STACK_CLEARING -lowerBound BF -execute"
